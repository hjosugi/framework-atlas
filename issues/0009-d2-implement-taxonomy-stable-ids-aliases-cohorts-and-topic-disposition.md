...
## Acceptance
- [ ] ReactはUI library、Vueはprogressive frameworkとして同一kindに強制しない。
- [ ] Gin/httprouter、Vue/vue-router、Hono/router implementationを別entityで結べる。
- [ ] duplicate alias/cyclic aliasを拒否。
- [ ] quarantine reason codeが必須。
- [ ] category追加はschema versionを壊さずreview可能。
