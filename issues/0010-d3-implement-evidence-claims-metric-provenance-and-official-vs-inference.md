...
## Acceptance
- [ ] marketing claimとAtlas measurementを別kindで保持。
- [ ] official influenceと類似推論を相互変換不可。
- [ ] sourceなし数値を拒否。
- [ ] sourceの最大引用量ではなく要約とpointerだけを保存。
- [ ] stale evidenceを削除せずreview_dueへ移す。
