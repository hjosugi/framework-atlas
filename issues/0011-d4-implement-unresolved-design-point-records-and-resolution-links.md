...
## Acceptance
- [ ] owner entityとimplementation issueが必須。
- [ ] resolved時にdecision/evidence linkが必須。
- [ ] 放置項目をfreshness reportが検出。
- [ ] profile本文との孤立を拒否。
- [ ] UIでcohort/dimension/status filter可能なdataになる。
