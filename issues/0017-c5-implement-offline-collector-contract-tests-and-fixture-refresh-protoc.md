...
## Acceptance
- [x] CIはGitHub APIを呼ばない。
- [x] 各failure modeに一fixture。
- [x] fixtureにtoken/user private dataなし。
- [x] refresh前後diffがreview可能。
- [x] malformed API responseをtyped errorとして拒否。
- [x] test順に依存しない。
