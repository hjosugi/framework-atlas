...
## Acceptance
- [x] FastAPI/Starlette/Pydantic/Uvicornを別entity。
- [x] type annotationとruntime validationの境界を説明。
- [x] dependency override/lifespan/background taskのeffect visibilityを評価。
- [x] official feature claimとlocal measurementを分離。
- [x] request modelをDBへ直接渡す利便性とdomain/data coupling riskを記録。
- [x] kofun contract/capabilityへのmappingを持つ。
