...
## Acceptance
- [x] Gin frameworkとhttprouter/router conceptを分離。
- [x] Contextのrequest scopeとgoroutine利用時copy規則を記録。
- [x] minimal APIの長所とimplicit mutable contextのtrade-offを比較。
- [x] middleware order/error propagation/shutdownを図示dataへ落とす。
- [x] marketing “40x”をAtlas measurementにしない。
- [x] kofun static dispatch/closed result mappingを持つ。
